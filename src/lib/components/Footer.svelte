...
<footer class="border-t border-white/5 bg-secondary py-12 text-white/70">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="grid gap-8 md:grid-cols-4">
			<div class="col-span-2">
				...
				<p class="mb-6 max-w-sm text-white/60">
					{lang === 'el'
				...
				{#if socials.facebook || socials.instagram || socials.linkedin}
					<div>
						<h4 class="mb-4 text-sm font-semibold tracking-wider text-white/50 uppercase">
						...
						<div class="flex space-x-4">
							{#if socials.facebook}
								<a
									...
									class="text-white/60 transition-colors hover:text-blue-600"
								>
							...
							{#if socials.instagram}
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									class="text-white/60 transition-colors hover:text-pink-600"
								>
							...
							{#if socials.linkedin}
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									class="text-white/60 transition-colors hover:text-blue-700"
								>
